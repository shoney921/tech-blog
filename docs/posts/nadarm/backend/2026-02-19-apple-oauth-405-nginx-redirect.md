---
title: "나닮 백엔드 — Apple 로그인만 405가 뜨는데, 카카오랑 구글은 멀쩡하다"
date: 2026-02-19T10:00:00
---

# 나닮 백엔드 — Apple 로그인만 405가 뜨는데, 카카오랑 구글은 멀쩡하다

나닮에 소셜 로그인을 붙이면서 카카오, 구글, Apple 세 가지를 지원하기로 했다. 카카오와 구글은 순탄하게 붙었다. OAuth 흐름 자체가 비슷하니까, 하나 해봤으면 나머지는 복붙에 가까웠다. 그런데 Apple 로그인을 추가한 순간부터 이상한 일이 벌어졌다.
